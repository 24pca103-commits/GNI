        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex sm:hidden items-center gap-1.5 shrink-0">
              <Link
                to="/register"
                className="px-2.5 py-1 rounded-full font-['DM_Sans'] text-[11px] font-semibold text-[#F7F2E8] bg-[#4A2C20] hover:bg-[#6B4030] transition-colors shadow-xs"
              >
                Register
              </Link>
              <button
                onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
                className="p-1 text-[#241A16] hover:text-[#B89555] transition-colors"
