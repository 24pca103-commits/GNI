...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#F7F2E8] text-[#241A16] border-t border-[#6B4030]/20 pt-10 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-8 border-b border-[#6B4030]/15 items-start">
          {/* Brand Info (6 cols) */}
          <div className="md:col-span-6 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col justify-center">
                <div className="flex items-center">
                  <span className="font-['Cormorant_Garamond'] text-2xl font-bold tracking-tight text-[#241A16]">
            ...
            <p className="font-['Cormorant_Garamond'] italic text-lg text-[#6B4030] font-normal">
          ...
          <div className="md:col-span-2 flex md:justify-end">
            <button
              onClick={scrollToTop}
              className="w-10 h-10 rounded-xl bg-white hover:bg-[#4A2C20] text-[#6B4030] hover:text-[#B89555] border border-[#6B4030]/20 shadow-xs transition-all duration-200 flex items-center justify-center cursor-pointer"
        ...
        {/* Bottom Copyright */}
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-['DM_Sans'] text-[#6B4030]">
          <p>© <span className="font-number font-normal">2026</span> Global Nagas Institute. All Rights Reserved.</p>
          <p className="text-xs">Designed with ancient Tamil cultural reverence.</p>
        </div>
      </div>
    </footer>
  );
